...
namespace Cashier
{
    ...
    public static class AccessHelper
    {
        ...
        //数据库连接字符串  
        public static string app_path = ApplicationDeployment.IsNetworkDeployed
              ? ApplicationDeployment.CurrentDeployment.DataDirectory
              : Path.GetDirectoryName(Application.ExecutablePath);

        public static string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source= " + app_path + "//db.mdb";

        //public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source= "+System.Windows.Forms.Application.StartupPath+"\\db.mdb";
